...
module.exports = function(app, options) {
  ...
  users.findByUsernameOrEmail = function(usernameOrEmail, companyId, done) {
    const usernameRegexp = new RegExp('^' + usernameOrEmail.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&') + '$', 'i');

    debug('users.findByUsernameOrEmail(' + usernameOrEmail + ', ' + companyId + ')');
    ...
    userModel.findOne({where: query}, done);
  };
