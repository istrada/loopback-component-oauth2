  ...
  handlers.authorization = [
    function(req, res, next) {
      ...
      if (req && req.query && req.query.prompt && req.query.prompt === 'login') {
        ...
        let redirectUrl = '/oauth/authorize?response_type=' + req.query.response_type + '&client_id=' + req.query.client_id + '&scope=' + req.query.scope + '&redirect_uri=' + req.query.redirect_uri;
